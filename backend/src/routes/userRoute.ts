...
// Update password
userRouter.put("/update-password", authMiddleware, async (req: AuthRequest, res: Response) => {
...
// Delete account
userRouter.delete("/delete-user", authMiddleware, async (req: AuthRequest, res: Response) => {
